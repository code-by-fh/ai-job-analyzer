...
export const translations = {
    en: {
        ...
        factoryResetConfirm: "WARNING: This will delete ALL jobs, your entire profile and all notification adapter configs. This cannot be undone.",
        ...
        resendApiInfo: "API key from resend.com. Jobs are sent as a batched digest email.",
        resendSetupGuide: "Setup",
        resendStep1: "Create an account at resend.com (free plan available)",
        resendStep2: "Verify your domain: Settings → Domains → Add Domain, then set the DNS records at your domain provider",
        resendStep3: "Create an API key: Settings → API Keys → Create API Key",
        resendStep4: "Enter the API key and sender email (e.g. noreply@your-domain.com) below and save",
        resendStep5: "On the dashboard: enable the Mail adapter per platform (✉ icon) and enter recipient addresses",
        ...
        mailjetStep2: "Verify your sender domain: Sender Domains & Addresses → Add a Domain",
        mailjetStep3: "Retrieve API keys: Account → API Key Management → API Key + Secret Key",
        mailjetStep4: "Enter API Key, Secret Key and sender email below and save",
        mailjetStep5: "On the dashboard: enable the MJ adapter per platform and enter recipient addresses",
        ...
        smtpProviderNote: "Click a provider to auto-fill the host. All use port 587 with STARTTLS. With 2FA enabled, an app password is usually required.",
        smtpHost: "SMTP Host",
        smtpPort: "Port",
        ...
        // Storage Settings
        storage: "Storage",
        storageDescription: "Manage your external document storage and cloud integrations.",
        googleDrive: "Google Drive",
        storageType: "Storage Method",
        storageStandard: "Standard (Database)",
        storageGoogleDrive: "Google Drive",
        googleDriveDescription: "Automatically sync your resumes and applications to Google Drive.",
        ...
        databaseDescription: "Files are stored directly in the application database.",
        googleDriveStorageDescription: "Files are synchronized with your Google Drive.",
        storageSetupGuide: "Setup Guide",
        storageStep1: "Connect your Google Drive account using the button below.",
        storageStep2: "Grant the necessary permissions to allow the App to save files in its own folder.",
        storageStep3: "All uploaded or AI-generated documents will now be automatically saved to your Google Drive.",
        ...
        googleStep3: "Configure the 'OAuth consent screen' (External) and add yourself as a Test User.",
        googleStep4: "Go to 'Credentials' and create an 'OAuth 2.0 Client ID' (Web Application).",
        ...
        storageRequiredMessage: "To upload files, you must first connect an external storage service like Google Drive.",
    ...
    de: {
        ...
        factoryResetConfirm: "WARNUNG: Dies wird ALLE Jobs, dein gesamtes Profil und alle Benachrichtigungs-Adapter-Konfigurationen löschen. Dies kann nicht rückgängig gemacht werden.",
        ...
        resendApiInfo: "API-Schlüssel von resend.com. Jobs werden als Digest-E-Mail gebündelt versendet.",
        resendSetupGuide: "Einrichtung",
        resendStep1: "Konto auf resend.com erstellen (kostenloser Plan verfügbar)",
        resendStep2: "Domain verifizieren: Settings → Domains → Add Domain, dann DNS-Einträge beim Domain-Anbieter setzen",
        resendStep3: "API-Schlüssel erstellen: Settings → API Keys → Create API Key",
        resendStep4: "API-Schlüssel und Absender-E-Mail (z.B. noreply@deine-domain.de) unten eintragen und speichern",
        resendStep5: "Auf dem Dashboard: pro Plattform den Mail-Adapter aktivieren (✉ Symbol) und Empfänger-Adressen eintragen",
        resendApiKey: "API Key",
        resendFromEmail: "Absender-E-Mail",
        resendRecipients: "Empfänger (kommagetrennt)",
        mailjetSetupGuide: "Einrichtung",
        mailjetStep1: "Konto auf mailjet.com erstellen (kostenloser Plan verfügbar)",
        mailjetStep2: "Absender-Domain verifizieren: Sender Domains & Addresses → Add a Domain",
        mailjetStep3: "API-Schlüssel abrufen: Account → API Key Management → API Key + Secret Key",
        mailjetStep4: "API Key, Secret Key und Absender-E-Mail unten eintragen und speichern",
        mailjetStep5: "Auf dem Dashboard: pro Plattform den MJ-Adapter aktivieren und Empfänger-Adressen eintragen",
        mailjetApiKey: "API Key",
        mailjetSecretKey: "Secret Key",
        ...
        smtpProviderNote: "Anbieter anklicken um den Host automatisch einzutragen. Alle nutzen Port 587 mit STARTTLS. Bei aktivierter 2FA ist meist ein App-Passwort nötig.",
        smtpHost: "SMTP Host",
        smtpPort: "Port",
        ...
        // Storage Settings
        storage: "Speicher",
        storageDescription: "Verwalte deinen externen Dokumentenspeicher und Cloud-Integrationen.",
        googleDrive: "Google Drive",
        storageType: "Speichermethode",
        storageStandard: "Standard (Datenbank)",
        storageGoogleDrive: "Google Drive",
        googleDriveDescription: "Synchronisiere deine Lebensläufe und Bewerbungen automatisch mit Google Drive.",
        ...
        databaseDescription: "Dateien werden direkt in der Anwendungs-Datenbank gespeichert.",
        googleDriveStorageDescription: "Dateien werden mit deinem Google Drive synchronisiert.",
        storageSetupGuide: "Einrichtungs-Anleitung",
        storageStep1: "Verbinde dein Google Drive Konto über den untenstehenden Button.",
        storageStep2: "Erteile die nötigen Berechtigungen, damit die App Dateien in einem eigenen Ordner speichern darf.",
        storageStep3: "Alle hochgeladenen oder KI-generierten Dokumente werden ab jetzt automatisch in dein Google Drive übertragen.",
        googleCloudProjectSetup: "1. Google Cloud Projekt Einrichtung",
        googleStep1: "Gehe zur Google Cloud Console und erstelle ein neues Projekt.",
        googleStep2: "Aktiviere die 'Google Drive API' in der API-Bibliothek.",
        googleStep3: "Konfiguriere den 'OAuth-Zustimmungsbildschirm' (Extern) und füge dich als Testnutzer hinzu.",
        googleStep4: "Gehe zu 'Anmeldedaten' und erstelle eine 'OAuth 2.0-Client-ID' (Webanwendung).",
        ...
        storageRequiredMessage: "Um Dateien hochzuladen, musst du zuerst einen externen Speicherdienst wie Google Drive verbinden.",
