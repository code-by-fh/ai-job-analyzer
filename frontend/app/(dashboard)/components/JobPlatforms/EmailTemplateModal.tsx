                    ...
                    <div className="flex items-center justify-between p-5 border-b border-slate-100 dark:border-slate-800 shrink-0">
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mt-1 flex flex-wrap items-center gap-x-1 gap-y-0.5">
                                ...
                                &nbsp;|&nbsp;
                                {['$title', '$company', '$match_score', '$reasoning', '$url', '$userName', '$jobCount'].map(v => varBtn(v))}
                            </p>
                        </div>
                    ...
                    <div className="p-5 flex-1 overflow-auto space-y-4 min-h-0">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full text-xs bg-slate-50 dark:bg-slate-950 border rounded-lg px-3 py-2 text-slate-800 dark:text-slate-200 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 ${!recipientsValue.trim()
                                        ? 'border-rose-300 dark:border-rose-700 bg-rose-50/30 dark:bg-rose-900/10'
                                        : 'border-slate-200 dark:border-slate-700'
                                    }`}
                            />
                            {!recipientsValue.trim() && (
                                <p className="text-[10px] text-rose-500 mt-1">Pflichtfeld — ohne Empfänger kann keine E-Mail gesendet werden.</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {templateValue && tab === 'editor' && (
                                <button
                                    onClick={() => { onTemplateChange(''); setSelectedTemplateId('__default__'); }}
                    ...
                    <div className="flex justify-between items-center p-5 border-t border-slate-100 dark:border-slate-800 shrink-0">
                        <div className="flex flex-col gap-1">
                            <button
                                ...
                                className={`px-3 py-2 text-xs font-medium rounded-lg border transition-all cursor-pointer flex items-center gap-1.5 disabled:opacity-60 ${testStatus === 'ok' ? 'text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10 border-emerald-200 dark:border-emerald-800' :
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className={`px-4 py-2 text-sm font-bold rounded-lg transition-colors cursor-pointer shadow-sm disabled:opacity-60 flex items-center gap-1.5 ${saveStatus === 'saved' ? 'text-white bg-emerald-600' :
