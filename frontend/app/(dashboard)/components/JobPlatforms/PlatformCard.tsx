      ...
      <div className="px-3 py-2.5 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-3">
            {/* Favicon */}
            <div
              className={`w-12 h-12 rounded-lg flex items-center justify-center shrink-0 border p-1.5 transition-all duration-200
                            ${
                              platform.is_active
            ...
            <div className="min-w-0 flex-1">
              ...
              {isEditingName ? (
                <div className="flex items-center gap-1">
                  ...
                  <button
                    ...
                    className="p-1.5 sm:p-1 text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-500/10 rounded-md cursor-pointer transition-colors active:scale-90"
                  >
                    <svg
                  ...
                  <button
                    ...
                    className="p-1.5 sm:p-1 text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md cursor-pointer transition-colors active:scale-90"
                  >
                    <svg
                      className="w-4 h-4 sm:w-3.5 sm:h-3.5"
                      fill="none"
                ...
                <div className="flex items-center gap-2 group/name-row">
                  <div
                    className={`flex items-center min-w-0 flex-1 gap-2 p-1 -m-1 rounded-lg transition-colors
                                        ${platform.is_active ? "hover:bg-slate-50 dark:hover:bg-slate-800/50" : ""}`}
                  >
                    <span
                      className={`font-semibold text-sm leading-tight transition-colors truncate
                                            ${
                                              platform.is_active
              ...
              {isEditingUrl ? (
                ...
                <div className="mt-1 group/url-row">
                  <div
                    className={`flex items-center gap-2 p-1 -m-1 rounded-lg transition-colors
                                        ${platform.is_active ? "hover:bg-slate-50 dark:hover:bg-slate-800/50" : ""}`}
                  >
                    <a
                      href={platform.url}
        ...
        <div className="flex flex-col items-center gap-2 shrink-0 self-stretch pl-2 sm:pl-3 border-l border-slate-100 dark:border-slate-800/60 transition-all duration-300 ml-1">
          ...
          <div className="flex items-center pt-px mt-0.5">
            <button
              onClick={() =>
                !isBusy && onToggleActive(platform.id, !platform.is_active)
              }
              disabled={isBusy}
              title={
                isBusy
            ...
            >
              <span
                className={`inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow-md transition-all duration-300
