    ...
    return (
        ...
        >
            ...
            <div className="relative w-full flex justify-between px-1.5 text-[10px] font-bold z-10 select-none">
                <span className={`transition-colors duration-300 ${language === 'de' ? 'text-white' : 'text-slate-500 dark:text-slate-400'}`}>
                    DE
                </span>
                <span className={`transition-colors duration-300 ${language === 'en' ? 'text-white' : 'text-slate-500 dark:text-slate-400'}`}>
                    EN
                </span>
            </div>
        </button>
