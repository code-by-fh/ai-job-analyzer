  ...
  return (
    <div className="space-y-4">
      ...
      {items.map((item, index) => (
        <div key={index} className="bg-slate-50 dark:bg-slate-950/30 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm relative group hover:border-indigo-200 dark:hover:border-indigo-500/30 transition-colors">
