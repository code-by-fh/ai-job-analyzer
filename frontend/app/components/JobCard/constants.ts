...
export const STATUS_META: Record<string, StatusMeta> = {
  OPEN: {
    ...
    stepActive:
      "bg-white dark:bg-slate-900 border-slate-400 dark:border-slate-400 text-slate-700 dark:text-slate-200 ring-2 ring-slate-300 dark:ring-slate-600 shadow-lg",
  ...
  DRAFTED: {
    ...
    stepActive:
      "bg-white dark:bg-slate-900 border-indigo-500 text-indigo-700 dark:text-indigo-300 ring-2 ring-indigo-300 dark:ring-indigo-500/50 shadow-lg shadow-indigo-100 dark:shadow-indigo-900/20",
  ...
  APPLIED: {
    ...
    stepActive:
      "bg-white dark:bg-slate-900 border-blue-500 text-blue-700 dark:text-blue-300 ring-2 ring-blue-300 dark:ring-blue-500/50 shadow-lg shadow-blue-100 dark:shadow-blue-900/20",
  ...
  INTERVIEW: {
    ...
    stepActive:
      "bg-white dark:bg-slate-900 border-amber-500 text-amber-700 dark:text-amber-300 ring-2 ring-amber-300 dark:ring-amber-500/50 shadow-lg shadow-amber-100 dark:shadow-amber-900/20",
  ...
  OFFER: {
    ...
    cardBorder:
      "border-emerald-300 dark:border-emerald-600/50 shadow-emerald-50 dark:shadow-emerald-900/20",
    stepDone: "bg-emerald-500 border-emerald-500 text-white",
    stepActive:
      "bg-white dark:bg-slate-900 border-emerald-500 text-emerald-700 dark:text-indigo-300 ring-2 ring-emerald-300 dark:ring-emerald-500/50 shadow-lg shadow-emerald-100 dark:shadow-emerald-900/20",
  ...
  ACCEPTED: {
    ...
    cardBorder:
      "border-teal-300 dark:border-teal-500/60 shadow-lg shadow-teal-50 dark:shadow-teal-900/30",
    stepDone: "bg-teal-500 border-teal-500 text-white",
    stepActive:
      "bg-white dark:bg-slate-900 border-teal-500 text-teal-700 dark:text-teal-300 ring-2 ring-teal-300 dark:ring-teal-500/50 shadow-lg shadow-teal-100 dark:shadow-teal-900/20",
  ...
  REJECTED: {
    ...
    stepActive:
      "bg-white dark:bg-slate-900 border-rose-500 text-rose-700 dark:text-rose-300 ring-2 ring-rose-300 dark:ring-rose-500/50 shadow-lg",
  ...
  FAILED: {
    ...
    stepActive:
      "bg-white dark:bg-slate-900 border-rose-400 text-rose-700 dark:text-rose-300 ring-2 ring-rose-300 dark:ring-rose-500/50 shadow-lg",
    connectorCls: "bg-rose-400",
  },
  GENERATING: {
    icon: "Loader2",
...
export const STATUS_GUIDANCE: Record<string, StatusGuidance> = {
  OPEN: {
    ...
    items: [
      {
        text: "Read AI analysis (Overview tab)",
        textKey: "guidanceOpenItem1",
        tabHint: "overview",
      },
      {
        text: "Read job description completely",
        textKey: "guidanceOpenItem2",
        descHint: true,
      },
      {
        text: "Short research on the company",
        textKey: "guidanceOpenItem3",
        tabHint: "company",
      },
      {
        text: "Start application draft",
        textKey: "guidanceOpenItem4",
        tabHint: "application",
      },
    ],
  ...
  DRAFTED: {
    ...
    items: [
      {
        id: "has_draft",
        text: "Application draft generated",
        textKey: "guidanceDraftedItem1",
        tabHint: "application",
      },
      {
        text: "Check draft for completeness and tone",
        textKey: "guidanceDraftedItem2",
      },
      {
        text: "Personalize cover letter (name, job reference)",
        textKey: "guidanceDraftedItem3",
      },
      {
        text: "Send documents / fill out form",
        textKey: "guidanceDraftedItem4",
      },
    ],
    ...
    items: [
      {
        ...
        textKey: "guidanceAppliedItem1",
      },
      {
        id: "has_followup",
        text: "Follow-up date set",
        textKey: "guidanceAppliedItem2",
      },
      {
        id: "has_prep",
        text: "Interview prep prepared",
        textKey: "guidanceAppliedItem3",
        tabHint: "interview",
      },
      {
        text: "Patience: feedback time is often 2–4 weeks",
        textKey: "guidanceAppliedItem4",
      },
    ],
  ...
  INTERVIEW: {
    ...
    items: [
      {
        id: "has_prep",
        text: "Interview prep material generated",
        textKey: "guidanceInterviewItem1",
        tabHint: "interview",
      },
      {
        text: "3 own strength examples (STAR method) prepared",
        textKey: "guidanceInterviewItem2",
      },
      {
        text: "Questions for the company prepared",
        textKey: "guidanceInterviewItem3",
      },
      {
        text: "Logistics cleared (location, time, contact, video link)",
        textKey: "guidanceInterviewItem4",
      },
    ],
    ...
    items: [
      {
        ...
        textKey: "guidanceOfferItem1",
      },
      {
        text: "Compared salary benchmark",
        textKey: "guidanceOfferItem2",
        tabHint: "company",
      },
      { text: "Identified negotiation room", textKey: "guidanceOfferItem3" },
      {
        text: "Take 48h to think (professional & common)",
        textKey: "guidanceOfferItem4",
      },
    ],
  ...
  ACCEPTED: {
    bgCls:
      "bg-teal-50/50 dark:bg-teal-500/5 border-teal-200 dark:border-teal-500/20",
    ...
    items: [
      {
        ...
        textKey: "guidanceFailedItem1",
      },
      {
        text: "Check application draft manually",
        textKey: "guidanceFailedItem2",
      },
      {
        text: "Tried to regenerate",
        textKey: "guidanceFailedItem3",
        tabHint: "application",
      },
      {
        text: "Contact support if problem persists",
        textKey: "guidanceFailedItem4",
      },
    ],
